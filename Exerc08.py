...
#CT0108 – Oitava contribuição da primeira etapa                                                                                                                                     #
...
#"Função Bucket + Função '.sort()' do Python(Tim Sort)" (EXTRA - Apenas para motivos de comparação mesmo! ;D)
#Implementação do aluno#########################################################################{
